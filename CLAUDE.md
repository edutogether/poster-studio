...
| 10 | 비용 관리/과금 안전장치 | 96 | −4: 예산 여유가 산수상 25% 수준(2000명×2회×$0.04=$160 vs $200) — 실사용률 따라 초과 가능, 코드로 더 못 줄임. **3·7번과 달리 유지**: 이건 "미래의 가정"이 아니라 지금 이 순간 확정된 숫자들에서 그대로 나오는 산술적 여유폭(대표 확인) |
| **평균** | | **99.1**(2·3·7번 재검토 반영 — 감점 근거가 "포기한 것 없음"·"미래 가정"인 항목은 100으로 정정, "지금 실재하는 공백/숫자"인 4·10번은 유지) | |
...
**4번·10번은 같은 논리로도 감점 유지가 맞다고 대표가 직접 구분함**: 이 둘은 "미래에 대한 가정"이 아니라 "지금 이 순간 실재하는 공백/숫자"다 — 4번은 자동검증이 안 되는 코드가 지금 실제로 존재하는 것(테스트 커버리지의 정의상 결손), 10번은 이미 확정된 다른 숫자들(2000명·2회·$0.04·$200)에서 그대로 나오는 산술적 여유폭. 종류가 다른 감점이라 재검토 대상이 아니었다.

**최종 평균 99.1** — 위 표(2·3·7번 100점 정정) 참고. 이 재판정도 2·3·7번과 동일하게 앞으로 재론의하지 않는 종결 사항으로 취급한다.
